...
contract DLT is Context, IDLT{
    ...
    mapping(int64 => mapping(address => mapping(int64 => uint256))) internal _balances;
    mapping(address => mapping(address => mapping(int64 => mapping(int64 => uint256)))) private _allowances;
