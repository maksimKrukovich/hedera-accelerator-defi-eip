...
import { TokenDLTStorage } from "../TokenDLTStorage.sol";

contract DLT is IDLT, TokenDLTStorage {
    ...
    function safeBatchTransferFrom(
        address sender,
        address recipient,
        int64[] calldata mainIds,
        int64[] calldata subIds,
    ...
    function _safeMint(
        ...
        _mintToken(recipient, mainId, subId, amount);
        require(
            _checkOnDLTReceived(
                address(0),
                recipient,
    ...
    function _safeBatchTransferFrom(
        ...
        for (uint256 i = 0; i < mainIds.length; ++i) {
            int64 mainId = mainIds[i];
            int64 subId = subIds[i];
    ...
    function _approve(
        ...
        _dlt_allowances[owner][spender][mainId][subId] = amount;
    ...
    function _allowance(
        ...
        return _dlt_allowances[owner][spender][mainId][subId];
    }
