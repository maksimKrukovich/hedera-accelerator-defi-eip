...
interface ITokenDLT {
     ...
     *  emits _toList.length `Transfer` events
     */
    function batchMint(address[] calldata _toList, int64[] calldata _mainIds, int64[] calldata _subIds, uint256[] calldata _amounts) external;
     ...
     */
    function batchBurn(address[] calldata _userAddresses, int64[] calldata _mainIds, int64[] calldata _subIds, uint256[] calldata _amounts) external;
