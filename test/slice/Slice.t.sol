...
contract SliceTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(owner);
        vToken1 = new BasicVault(
            IERC20(address(underlying1)),
            "TST",
            "TST",
            zeroFeeConfig,
            owner,
        ...
        vm.prank(owner);
        vToken2 = new BasicVault(
            IERC20(address(underlying2)),
            "TST",
            "TST",
            zeroFeeConfig,
            owner,
        ...
        vm.prank(owner);
        aToken1 = new AutoCompounder(uniswapRouter, address(vToken1), address(rewardToken), "TST", "TST", address(0));
        vm.prank(owner);
        aToken2 = new AutoCompounder(uniswapRouter, address(vToken2), address(rewardToken), "TST", "TST", address(0));
    ...
    function testRebalance() public {
        uint256 amountToDeposit = 50e12;
        uint256 rewardAmount = 50000000e18;
        ...
        deal(address(underlying1), owner, 5000000e20);
        deal(address(underlying2), owner, 5000000e20);
        deal(address(rewardToken), owner, 5000000e20);
